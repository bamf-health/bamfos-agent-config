...
Nuxt projects should also use the `tailwindReferencePlugin` to automatically add the Tailwind CSS import to your Vue components. See [vue-nuxt Tailwind](../../frontend-vue-nuxt/references/tailwind.md) for more information.
...
- Nuxt and TailwindCSS: [frontend-vue-nuxt/references/tailwind.md](../../frontend-vue-nuxt/references/tailwind.md)
